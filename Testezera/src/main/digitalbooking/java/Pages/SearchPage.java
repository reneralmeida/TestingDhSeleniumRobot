...
public class SearchPage extends BasePage {
    ...
    protected static final String inputData = "//*[@id=\"buscador\"]/div/div[2]/div[1]/div/input\n";
    ...
    public void inserirData() {
        WebElement data = getWebElement(By.xpath(inputData));
        data.clear();
        data.sendKeys("20/04/2023 - 22/04/2023");
    }
    public void inserirData(String dataInserida) {
        WebElement data = getWebElement(By.xpath(inputData));
        data.clear();
        data.sendKeys(dataInserida);
    }
